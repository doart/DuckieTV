 ...
 */
DuckieTV.factory('TraktTVUpdateService', ["$q", "TraktTVv2", "FavoritesService", "TMDB",
    function($q, TraktTVv2, FavoritesService, TMDB) {
              ...
              return TraktTVv2.trending(true).then(function(result) {
                return Promise.all(result.map(function(serie) {
                  return new Promise(function(resolve) {
                    ...
                    TMDB.getSerieImages(serie.tmdb_id).then(function(images) {
                      serie.poster = images.poster;
                      return resolve(serie);
                    });
                  });
                })).then(function(shows) {
